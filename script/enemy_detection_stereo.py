...
# === Load YOLOv8 model ===
model = YOLO('/home/shanoj/catkin_ws/src/turret_gun_description/script/human_detection/runs/detect/train10/weights/best.pt')
# model.verbose = False
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        results = model(rectL, verbose = False)[0]
